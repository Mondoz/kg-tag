...
public class KGMongoSingleton {
	 ...
	 * log
	 */
	private static final Logger log = Logger.getLogger(KGMongoSingleton.class);
	/**
	 * mongo url
	 */
	private static final String MONGODB_URL = ConstResource.KGMONGOURL;

	/**
	 * mongo port
	 */
	private static final int MONGODB_PORT = ConstResource.KGMONGOPORT;
